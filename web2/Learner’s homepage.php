...
<body onload="start()">
    <header>
        <nav>
            <ul>
                <li><a href="index.html"><img src="images/mindly.png" alt="Mindly Logo" /></a></li>
    ...
    <script>
        ...
        style.innerHTML = `
            @keyframes typing {
                ...
                to { width: ${textLength}ch; opacity:1; }
            }
            ...
            .welcome {
                animation: typing 2s steps(${textLength}) 1s 1 forwards, blinkCursor 0.75s step-end infinite;
            }
        `;
        ...
        takeQuizBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                window.location.href = 'TakeAquiz.html';
            });
        });
