...
<html lang="en">
  <head>
    ...
    <style>
          /* Shared group header/footer CSS */
          html {
  ...
  <body>
    ...
    <!-- Comments content -->
    <div class="container">
      <h2>Comments for: Math Quiz</h2>
      <div class="note">All comments are posted anonymously</div>

      <div class="comment">
        <div class="comment-header">
          <span class="comment-anon">Anonymous</span>
          <span class="comment-date">September 13, 2025</span>
        </div>
        <div class="comment-text">
          I really enjoyed the algebra questions; they made me think critically.
        </div>
      </div>
      ...
      <div class="comment">
        <div class="comment-header">
          <span class="comment-anon">Anonymous</span>
          <span class="comment-date">September 12, 2025</span>
        </div>
        <div class="comment-text">
          Geometry problems were challenging but fun. Loved the diagrams!
        </div>
      </div>
      ...
      <div class="comment">
        ...
        <div class="comment-text">
          Good mix of calculus and statistics questions. Please add more word
          problems next time.
        </div>
      </div>
